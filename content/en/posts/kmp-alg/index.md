---
title: Principle of KMP Algorithm-solve String Matching Problem - CN
date: 2024-11-16
author: Whitea
...
也就是说KMP算法是用来解决字符串匹配问题，即从一个文本串`text`中寻找一个子字符串（模式串）`pattern`，看这个字串是否在主串中出现过。<font style="color:rgb(76, 73, 72);">比如对于 </font>`text='abaacababcac'`<font style="color:rgb(76, 73, 72);"> 和</font> `pattern='ababc'`<font style="color:rgb(76, 73, 72);">，子串是包含在主串中的，同时它在主串中的索引是</font>`<font style="color:rgb(76, 73, 72);">5</font>`<font style="color:rgb(76, 73, 72);">。</font>
...
![](https://cdn.nlark.com/yuque/0/2024/png/40714522/1712390232850-1570a28a-9fd5-4f27-b4b7-3b3bcf9b0b8a.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/40714522/1712390538647-d2ed3fd9-6b73-4fca-9ac6-c0f8346c5ee2.png)
...
![](https://cdn.nlark.com/yuque/0/2024/png/40714522/1712390672987-81dc9beb-519e-4464-8151-b3b7aaf1001c.png)
...
（作为我的第一篇博文，分享我关于KMP算法的思考，如有错误，请理解并及时联系我）
